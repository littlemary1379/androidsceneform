...
class TempRoomBean : Serializable {
    ...
    fun init() {
        ...
        var lineVector2: List<Vector3> = listOf(startRawVector1!!, endRawVector1!!)
        var lineVector3: List<Vector3> = listOf(startRawVector2!!, endRawVector2!!)
